...
export const metadata = {
  title: "Cookie Policy — SecuTools.io",
  description: "Learn about how SecuTools.io handles cookies, local storage, and client-side privacy.",
};
    ...
    <div className="max-w-4xl mx-auto px-4 py-8 text-slate-800 dark:text-slate-200">
      ...
      <div className="p-4 sm:p-6 mb-8 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
        <p className="text-base sm:text-lg leading-relaxed text-slate-700 dark:text-slate-300">
          This Cookie Policy explains how <strong className="text-slate-900 dark:text-white">SecuTools.io</strong> uses cookies and client-side storage technologies (such as <code className="text-xs bg-slate-100 dark:bg-slate-800 px-1 py-0.5 rounded">localStorage</code>). We are committed to transparency and data minimization.
        </p>
        <ManageCookiesButton />
      </div>
        ...
        <section className="space-y-4">
          ...
          <div className="p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-sm mb-3">
              Essential for the site to function properly and remember your local interface preferences (such as theme and tool favorites). These do not collect personal identifiers.
            </p>
            <div className="overflow-x-auto">
              <table className="w-full text-xs text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-slate-800 text-slate-600 dark:text-slate-300">
                  <tr>
                    <td className="p-2 font-mono text-indigo-600 dark:text-indigo-400">site_theme</td>
              ...
              <table className="w-full text-xs text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-slate-800 text-slate-600 dark:text-slate-300">
                  <tr>
                    ...
                    <td className="p-2">Measures aggregated Core Web Vitals and load performance</td>
